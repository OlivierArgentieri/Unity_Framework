...
{
    [Serializable]
    [CreateAssetMenu(fileName = "New Camera Setting", menuName = "UF/Camera/CameraSetting")]
    public class UF_CameraSetting : ScriptableObject
    {
        ...
        [SerializeField, Header("Offset X"), Range(-20, 20)]
        private float offsetX = 0;

        private float offsetXMax = 20;
        private float offsetXMin = -20;

        [SerializeField, Header("Offset Y"), Range(-20, 20)]
        private float offsetY = 0;

        private float offsetYMax = 20;
        private float offsetYMin = -20;

        [SerializeField, Header("Offset Z"), Range(-20, 20)]
        ...
        [SerializeField, Header("Clamp X Value Min"), Range(-180, 180)]
        private float clampXValueMin = 0;

        [SerializeField, Header("Clamp X Value Max"), Range(-180, 180)]
        private float clampXValueMax = 0;

        [SerializeField, Header("Clamp Y Value Min"), Range(-180, 180)]
        private float clampYValueMin = 0;

        [SerializeField, Header("Clamp Y Value Max"), Range(-180, 180)]
        private float clampYValueMax = 0;

        #endregion

        [SerializeField, Header("Follow Player ?")]
        private bool followPlayer = false;

        [SerializeField, Header("Focus Player ?")]
        private bool focusPlayer = false;

        [SerializeField, Header("Rotate Speed"), Range(0, 200)]
        ...
        [SerializeField, Header("Follow Target Speed"), Range(0, 100)]
