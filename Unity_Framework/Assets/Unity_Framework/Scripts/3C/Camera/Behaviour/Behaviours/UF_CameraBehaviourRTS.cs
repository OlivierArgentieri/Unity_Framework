...
namespace uf
{
    public class UF_CameraBehaviourRTS : UF_CameraBehaviour
    {
        ...
        protected override void FollowTarget()
        {
            ...
            CameraSetting.LocalCamera.transform.position = Vector3.Lerp(CameraSetting.LocalCamera.transform.position,
                Target.position + _offset, Time.deltaTime * CameraSetting.FollowSpeed);
        }
