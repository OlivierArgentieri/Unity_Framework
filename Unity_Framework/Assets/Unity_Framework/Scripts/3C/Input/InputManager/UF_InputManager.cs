...
namespace uf
{
    public class UF_InputManager : ManagerTemplate<UF_InputManager>
    {
        ...
        [SerializeField, Header("Horizontal Label")]
        private string moveHorizontalLabel = "Horizontal";

        [SerializeField, Header("Vertical Label")]
        private string moveVerticalLabel = "Vertical";
        ...
        [SerializeField, Header("Horizontal Axis Value")]
        private float moveHorizontalValue = 0;

        [SerializeField, Header("Vertical Axis Value")]
        private float moveVerticalValue = 0;
        ...
        [SerializeField, Header("RTS Move Player")]
        private List<UF_Key> moveRTSActions = new List<UF_Key>();

        [SerializeField, Header("RTS Move Player Value")]
        private bool moveRTSActionValue = false;
